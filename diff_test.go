...
func TestMonthDiff(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "6",
			args: args{
				t1: TimeYMD(2021, 1, 31),
				t2: TimeYMD(2020, 12, 1),
			},
			want: -1,
		},
		{name: "7",
			args: args{
				t1: TimeYMD(2021, 1, 1),
				t2: TimeYMD(2020, 12, 31),
			},
			want: 0,
		},
		{name: "8",
			args: args{
				t1: TimeYMD(2018, 12, 31),
				t2: TimeYMD(2021, 1, 1),
			},
			want: 24,
		},
		{name: "9",
			args: args{
				t1: TimeYMD(2018, 12, 15),
				t2: TimeYMD(2021, 1, 15),
			},
			want: 25,
		},
	}
...
func TestYearDiff(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "0",
			args: args{
				t1: TimeYMD(2021, 1, 1),
				t2: TimeYMD(2021, 8, 31),
			},
			want: 0,
		},
		{name: "1",
			args: args{
				t1: TimeYMD(2020, 2, 28),
				t2: TimeYMD(2021, 2, 28),
			},
			want: 1,
		},
		{name: "2",
			args: args{
				t1: TimeYMD(2020, 2, 29),
				t2: TimeYMD(2021, 2, 28),
			},
			want: 0,
		},
